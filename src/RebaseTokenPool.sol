...
contract RebaseTokenPool is TokenPool {
    constructor(IERC20 _token, uint8 _localTokenDecimals, address[] memory _allowlist, address _rmnProxy, address _ccipRouter)
     TokenPool(_token, _localTokenDecimals, _allowlist, _rmnProxy, _ccipRouter) {}
